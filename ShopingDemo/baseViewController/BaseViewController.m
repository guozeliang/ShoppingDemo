...
//     显示导航栏上的《一个》图标
    ...
    if (show) {
        // 初始化导航栏右侧的分享按钮
        UIButton *shareBtn = [[UIButton alloc]initWithFrame:CGRectMake(0.0, 0.0, 22, 22)];
        [shareBtn setBackgroundImage:[UIImage imageNamed:@"nav_share_btn_normal"] forState:UIControlStateNormal];
        [shareBtn setBackgroundImage:[UIImage imageNamed:@"nav_share_btn_highlighted"] forState:UIControlStateHighlighted];
